export function __validate_required_if_target_not_empty({
                                                                  ruleObj,
                                                                  fieldName,
                                                                  fieldLabel,
                                                                  index,
    ...
    if (!this.isEmpty(targetFieldValue) && this.isEmpty(fieldValue)) {
        ...
        isValid = false;
        message = ruleObj.message ? ruleObj.message : `${fieldLabel} is required if ${targetFieldLabel} is not empty`;
